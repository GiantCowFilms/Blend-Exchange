...
include($_SERVER["DOCUMENT_ROOT"]."/parts/blendDownloadCount.php");

foreach ($files as $key => $file)
{
    $files[$key]["views"] = getViewCount($file["id"]);
    
    $files[$key]["downloads"] = getDownloadCount($file["id"]);
};
...
<table id="blends_table">
    ...
    <tbody>
        ...
        foreach ($files as $file)
        {
            ...
            <td>".$file["views"]."</td><td>".$file["downloads"]."</td><td>".$file["date"]."</td></tr>";
        }
        ?>
    </tbody>
</table>
