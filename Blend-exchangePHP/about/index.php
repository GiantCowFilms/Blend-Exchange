<html>
    <?php include("../parts/header.php"); ?>
        <div id="mainContainer">
            ...
            <h2>Contributions</h2>
                <a href="http://blender.stackexchange.com/users/3127/giantcowfilms">GiantCowFilms:</a> Server administration, lead development and design, and some assistance with the userscript<br />
                <a href="http://blender.stackexchange.com/users/599/gandalf3">gandalf3:</a> Lead development on the userscript, minor development, editing, and the wonderful favicon.<br />
