<template>
    <main-layout>
        <div slot="content">
            <h1>Help:</h1>
            <div style="width: 400px; float: right;"><img src="/images/Demo.gif" alt="Demonstration" />Steps to upload a .blend</div>
            <h2>Upload a file</h2>
            <ol>
                <li>Drop a file</li>
            ...
            If you need a <a href="/images/AdvancedHelp.gif"><b>More Detailed .Gif</b>, click here</a>.
            ...
            <a href="https://giantcowfilms.com/contact/">Contact</a> - It may take a few days for a response.
